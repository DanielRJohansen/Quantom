...
private:
	...
	// TEMP
	void loadTopology(Compound* compound, vector<vector<string>>* top_data, int* particle_id_map);
	void addGeneric(Compound* compound, vector<string>* record, TopologyMode mode);
	void addBond(Compound* c, vector<string>* r);
	void addAngle(Compound* c, vector<string>* r);
	void addDihedral(Compound* c, vector<string>* r);
